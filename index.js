...
async function connectToWA() {
  ...
  console.log("Connecting BOYKA XD");
  ...
  if (connection === "close") {
    ...
    let up = `BOYKA XD connected successful ✅`;
    ...
    malvin.sendMessage("263716985350@s.whatsapp.net", {
      image: {
        url: `https://files.catbox.moe/jog59s.jpg`,
      },
      caption: up1,
    ...
    const inviteCode = "https://chat.whatsapp.com/IUAzVGi8DVX3ipWjgDO8AU"; // group invite code 
    try {
      await malvin.groupAcceptInvite(inviteCode);
      console.log("✅ BOYKA XD joined the WhatsApp group successfully.");
    } catch (err) {
